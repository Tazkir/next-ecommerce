...
const Loading = () => {
  return (
    <div className="flex w-full flex-1 flex-col items-center px-0 py-10">
      ...
      <div className="mt-5 w-3/4 h-2/4 animate-pulse flex-row items-center justify-center space-x-1 rounded-xl border p-6 ">
